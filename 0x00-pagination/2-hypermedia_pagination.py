...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict[str, Union[int, List[List]]]:
            ...
            next_page = None if page > (total_data / page_size) else page + 1

            hyper_dict = {'page':page, 'page_size':page_size, 
                'data':data, 'next_page':next_page, 'prev_page':prev_page, 'total_pages': math.ceil(total_data / page_size)}
